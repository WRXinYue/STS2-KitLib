...
///
/// The buffer is never drained between saves in the same session. Loading a
/// save restores the prefix recorded for that save (later actions after an
/// SL are not kept). Each ToSave overwrites the same run file.
/// </summary>
