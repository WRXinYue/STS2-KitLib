...
internal static class DiagnosticLog {
    ...
    private static void Ensure() {
        ...
        try {
            string dir = System.IO.Path.Combine(OS.GetUserDataDir(), "KitLib", "run-replays");
    ...
    internal static void WriteStartupFingerprint() {
        try {
            ...
            Write("Startup", $"mod version={ModVersion.Current} replayCore={ReplayFormat.CoreVersion}");
