...
- **Republished for KitLib 0.43.1** — Rebuilt against the shared self-contained picker now that `KitLib.ModVariantLoader` is removed. Behavior is unchanged; DevTools no longer depend on that host DLL.
