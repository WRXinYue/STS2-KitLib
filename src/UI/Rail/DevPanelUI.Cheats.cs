...
internal static partial class DevPanelUI {
    internal static void ShowCheatsOverlay(NGlobalUi globalUi, DevPanelActions actions) {
        ...
        if (MpCheatUi.IsFrameCheatAllowed) {
            secPlayer.AddChild(CreateCheatToggle(I18N.T("cheat.godMode", "God Mode"), I18N.T("cheat.godMode.desc", "Auto-heal to max HP every frame"), () => KitLibState.StatModifiers?.GodMode ?? false, v => { if (KitLibState.StatModifiers != null) KitLibState.StatModifiers.GodMode = v; }));
            secPlayer.AddChild(CreateCheatToggle(I18N.T("cheat.negateDebuffs", "Negate Debuffs"), I18N.T("cheat.negateDebuffs.desc", "Continuously remove all debuffs"), () => KitLibState.StatModifiers?.NegateDebuffs ?? false, v => { if (KitLibState.StatModifiers != null) KitLibState.StatModifiers.NegateDebuffs = v; }));
            secPlayer.AddChild(CreateCheatToggle(I18N.T("cheat.alwaysPlayerTurn", "Always Player Turn"), I18N.T("cheat.alwaysPlayerTurn.desc", "Force combat to player turn"), () => KitLibState.StatModifiers?.AlwaysPlayerTurn ?? false, v => { if (KitLibState.StatModifiers != null) KitLibState.StatModifiers.AlwaysPlayerTurn = v; }));
            secPlayer.AddChild(CreateCheatToggle(I18N.T("cheat.drawToLimit", "Draw to Hand Limit"), I18N.T("cheat.drawToLimit.desc", "Auto-draw to 10 cards"), () => KitLibState.StatModifiers?.DrawToHandLimit ?? false, v => { if (KitLibState.StatModifiers != null) KitLibState.StatModifiers.DrawToHandLimit = v; }));
            secPlayer.AddChild(CreateCheatToggle(I18N.T("cheat.extraDraw", "Extra Draw Each Turn"), I18N.T("cheat.extraDraw.desc", "Draw extra cards at turn start"), () => KitLibState.StatModifiers?.ExtraDrawEachTurn ?? false, v => { if (KitLibState.StatModifiers != null) KitLibState.StatModifiers.ExtraDrawEachTurn = v; }));
            secPlayer.AddChild(CreateCheatNumberEdit(I18N.T("cheat.extraDrawAmount", "Extra Draw Amount"), 1, 20, () => KitLibState.StatModifiers?.ExtraDrawEachTurnAmount ?? 1, v => { if (KitLibState.StatModifiers != null) KitLibState.StatModifiers.ExtraDrawEachTurnAmount = (int)v; }));
        }
        ...
        if (MpCheatSession.InMultiplayerRun) {
            ...
            secEnemy.AddChild(CreateCheatToggle(I18N.T("cheat.killAll", "Kill All Enemies"), I18N.T("cheat.killAll.desc", "Continuously kill all enemies"), () => KitLibState.StatModifiers?.KillAllEnemies ?? false, v => { if (KitLibState.StatModifiers != null) KitLibState.StatModifiers.KillAllEnemies = v; }));
        }
        if (MpCheatUi.IsFrameCheatAllowed)
            secEnemy.AddChild(CreateCheatToggle(I18N.T("cheat.autoAlly", "Auto-Act Friendly Monsters"), I18N.T("cheat.autoAlly.desc", "Auto-execute friendly monster turns"), () => KitLibState.StatModifiers?.AutoActFriendlyMonsters ?? false, v => { if (KitLibState.StatModifiers != null) KitLibState.StatModifiers.AutoActFriendlyMonsters = v; }));
        ...
        AddLockRow(CreateStatLockRow(I18N.T("statLock.gold", "Lock Gold"), 0, 99999, () => KitLibState.StatModifiers?.LockGold ?? false, v => { if (KitLibState.StatModifiers != null) KitLibState.StatModifiers.LockGold = v; }, () => KitLibState.StatModifiers?.LockedGoldValue ?? 0, v => { if (KitLibState.StatModifiers != null) KitLibState.StatModifiers.LockedGoldValue = (int)v; }, () => { if (!RunContext.TryGetRunAndPlayer(out _, out var p)) return 0; return p.Gold; }));
        AddLockRow(CreateStatLockRow(I18N.T("statLock.currentHp", "Lock Current HP"), 1, 9999, () => KitLibState.StatModifiers?.LockCurrentHp ?? false, v => { if (KitLibState.StatModifiers != null) KitLibState.StatModifiers.LockCurrentHp = v; }, () => KitLibState.StatModifiers?.LockedCurrentHpValue ?? 1, v => { if (KitLibState.StatModifiers != null) KitLibState.StatModifiers.LockedCurrentHpValue = (int)v; }, () => { if (!RunContext.TryGetRunAndPlayer(out _, out var p)) return 1; return p.Creature.CurrentHp; }));
        AddLockRow(CreateStatLockRow(I18N.T("statLock.maxHp", "Lock Max HP"), 1, 9999, () => KitLibState.StatModifiers?.LockMaxHp ?? false, v => { if (KitLibState.StatModifiers != null) KitLibState.StatModifiers.LockMaxHp = v; }, () => KitLibState.StatModifiers?.LockedMaxHpValue ?? 1, v => { if (KitLibState.StatModifiers != null) KitLibState.StatModifiers.LockedMaxHpValue = (int)v; }, () => { if (!RunContext.TryGetRunAndPlayer(out _, out var p)) return 1; return p.Creature.MaxHp; }));
        AddLockRow(CreateStatLockRow(I18N.T("statLock.currentEnergy", "Lock Current Energy"), 0, 99, () => KitLibState.StatModifiers?.LockCurrentEnergy ?? false, v => { if (KitLibState.StatModifiers != null) KitLibState.StatModifiers.LockCurrentEnergy = v; }, () => KitLibState.StatModifiers?.LockedCurrentEnergyValue ?? 0, v => { if (KitLibState.StatModifiers != null) KitLibState.StatModifiers.LockedCurrentEnergyValue = (int)v; }, () => { if (!RunContext.TryGetRunAndPlayer(out _, out var p)) return 0; return p.PlayerCombatState?.Energy ?? 0; }));
        AddLockRow(CreateStatLockRow(I18N.T("statLock.maxEnergy", "Lock Max Energy"), 1, 99, () => KitLibState.StatModifiers?.LockMaxEnergy ?? false, v => { if (KitLibState.StatModifiers != null) KitLibState.StatModifiers.LockMaxEnergy = v; }, () => KitLibState.StatModifiers?.LockedMaxEnergyValue ?? 1, v => { if (KitLibState.StatModifiers != null) KitLibState.StatModifiers.LockedMaxEnergyValue = (int)v; }, () => { if (!RunContext.TryGetRunAndPlayer(out _, out var p)) return 1; return p.MaxEnergy; }));
        AddLockRow(CreateStatLockRow(I18N.T("statLock.stars", "Lock Stars"), 0, 999, () => KitLibState.StatModifiers?.LockStars ?? false, v => { if (KitLibState.StatModifiers != null) KitLibState.StatModifiers.LockStars = v; }, () => KitLibState.StatModifiers?.LockedStarsValue ?? 0, v => { if (KitLibState.StatModifiers != null) KitLibState.StatModifiers.LockedStarsValue = (int)v; }, () => { if (!RunContext.TryGetRunAndPlayer(out _, out var p)) return 0; return p.PlayerCombatState?.Stars ?? 0; }));
        AddLockRow(CreateStatLockRow(I18N.T("statLock.orbSlots", "Lock Orb Slots"), 0, 10, () => KitLibState.StatModifiers?.LockOrbSlots ?? false, v => { if (KitLibState.StatModifiers != null) KitLibState.StatModifiers.LockOrbSlots = v; }, () => KitLibState.StatModifiers?.LockedOrbSlotsValue ?? 0, v => { if (KitLibState.StatModifiers != null) KitLibState.StatModifiers.LockedOrbSlotsValue = (int)v; }));
