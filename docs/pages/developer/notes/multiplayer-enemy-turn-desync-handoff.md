...
::: en
Maintainer handoff for coop enemy-turn soft-lock (issues **#9** / **#10**). See [LAN host-drive & AFK co-op](/developer/lan-host-drive-afk). Full notes in Chinese below.
:::
...
## 现象（210300 / godot.log ~17:50）{lang="zh-CN"}
...
### #10 回归（212268/210636）{lang="zh-CN"}
