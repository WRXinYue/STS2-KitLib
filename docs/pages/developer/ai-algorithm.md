...
## 快照字段（StrongStrategy 依赖）{lang="zh-CN"}
...
### 阶段扩展（`GameSnapshotPhaseCapture`）{lang="zh-CN"}
...
### CodexPriorCatalog（社区 prior，可选）{lang="zh-CN"}
...
## DeckEvaluator（牌组质量与删牌边际收益）{lang="zh-CN"}
...
### 单卡价值 ScoreInDeck（`DeckCardScoring`）{lang="zh-CN"}
...
### RelicCatalog / RelicMechanicIndex{lang="zh-CN"}
...
## StrongStrategy 阶段路由{lang="zh-CN"}
...
### CardRewardScorer（战斗后三选一）{lang="zh-CN"}
...
### DeckSelectScorer（休息 smith / 商店删牌）{lang="zh-CN"}
...
### MapPathPlanner（Act 全程路径 + 画线）{lang="zh-CN"}
...
### PotionScorer（战斗：全瓶打分，取最高 ≥25）{lang="zh-CN"}
...
### PotionInventoryScorer（宏观腰带）{lang="zh-CN"}
...
### BlockThreatEvaluator{lang="zh-CN"}
...
### CombatSetupEvaluator{lang="zh-CN"}
...
### CombatScorer（fallback 最小启发式）{lang="zh-CN"}
...
### Enemy Intelligence Layer{lang="zh-CN"}
...
### EnemyTargetPriority / MinionEngagementPolicy{lang="zh-CN"}
...
### Combat Simulation Layer{lang="zh-CN"}
...
## 执行层要点（Sts2ActionExecutor）{lang="zh-CN"}
