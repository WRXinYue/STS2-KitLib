...
- **卡牌测试** — 可将 mod 卡牌加入队列，在训练假人房间自动注入并测试未升级与升级版本。
- **卡牌测试（篝火）** — 在篝火处对队列卡牌进行敲牌升级预览，不打出卡牌。

### Changed

- **数值修改（作弊）** — 「数值锁定」改为 **数值修改**。
- **数值修改（作弊）** — 修改数字后立即生效，无需先勾选锁定。

### Fixed

- **联机战斗统计浮层** — 联机战斗中玩家贡献条重新可见。
- **联机战斗统计浮层** — 面板随战斗进度实时更新。
- **联机战斗统计浮层** — 可拖动调整位置。
