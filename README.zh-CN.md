...
- **KitLib**（本仓库宿主）— 先加载，再提供其他 mod 在初始化时调用的 API；同时负责设置、进度保护、主题和快捷键。
- **[KitModPanel](./mods/KitModPanel/README.zh-CN.md)** — 主菜单模组列表与各模组设置页。
- **[KitDevTools](./mods/KitDevTools/README.zh-CN.md)** — 标题画面 Dev Mode、局内侧栏、回放、作弊与联机调试。
- **[KitAI](./mods/KitAI/README.zh-CN.md)** — 可选的 AI 托管 / 自动游玩。
...
- **KitLib**（必需）以及 **KitModPanel** / **KitDevTools** / **KitAI**：Steam 创意工坊，或 [GitHub Releases](https://github.com/WRXinYue/STS2-KitLib/releases) / Nexus 的发布包。
